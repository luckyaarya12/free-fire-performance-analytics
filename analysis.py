...
# 1. FILE PATH & CHECK
# =========================
file_path = os.path.join("Data", "free_fire_clean_data.xlsx")

if not os.path.exists(file_path):
    raise FileNotFoundError(
        f"Excel file not found at {file_path}. "
        "Please make sure the 'Data' folder contains the Excel file."
    )
...
sns.scatterplot(data=df, x="time_playedhrs", y="kills")
...
# =========================
plt.figure(figsize=(8, 5))
sns.scatterplot(data=df, x="time_playedhrs", y="wins")
...
# =========================
plt.figure(figsize=(8, 5))
sns.histplot(data=df, x="kd_ratio", bins=10, kde=True)
...
# =========================
plt.figure(figsize=(8, 5))
sns.barplot(data=df, x="mode", y="kd_ratio", estimator=np.mean)
